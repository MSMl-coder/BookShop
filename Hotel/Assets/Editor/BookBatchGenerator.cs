...
// ═══════════════════════════════════════════════════════════════════════════
// СТРУКТУРА ПАПОК що генерується:
//   Assets/Data/Books/Generated/
//     Classic/
//       Jane_Austen/
//         BT_Pride_and_Prejudice.asset
//       Charles_Dickens/
//         BT_Oliver_Twist.asset
//     Fantasy/
//       L_Frank_Baum/        ← всі Oz одного кольору
//         BT_Wonderful_Wizard_of_Oz.asset
//       ...
//
// СЕРІЇ — автоматично отримують фіксований colorIndex:
//   Oz (Baum)             → colorIndex 0
//   Barsoom (Burroughs)   → colorIndex 1
//   Tarzan/Pellucidar     → colorIndex 2
//   Sherlock Holmes       → colorIndex 3
//   Arsène Lupin          → colorIndex 4
//   Father Brown          → colorIndex 5
//   Cthulhu Mythos        → colorIndex 6
//   Musketeers/Monte Cristo → colorIndex 7
//   Space Trilogy (Lewis) → colorIndex 9
//   Erewhon/Zenda         → colorIndex 10
//   Hewitt/Carrados/MacDonald → colorIndex 11
//   Alice/Peter Pan       → colorIndex 12
//   Plato + Aristotle     → colorIndex 13
//   Nietzsche             → colorIndex 14
//   Kant                  → colorIndex 15
// ═══════════════════════════════════════════════════════════════════════════
...
public class BookBatchGenerator : EditorWindow
{
    ...
    // ─────────────────────────────────────────────────────────────────────
    // СЕРІЇ: title → фіксований colorIndex
    // Книги однієї серії завжди отримують однаковий колір і префаб
    // ─────────────────────────────────────────────────────────────────────
    private static readonly Dictionary<string, int> SeriesColorMap =
        new Dictionary<string, int>(System.StringComparer.OrdinalIgnoreCase)
    {
        // [00] Oz (L. Frank Baum)
        { "The Wonderful Wizard of Oz",     0 },
        { "The Marvelous Land of Oz",       0 },
        { "Ozma of Oz",                     0 },
        { "Dorothy and the Wizard in Oz",   0 },
        { "The Road to Oz",                 0 },
        { "The Emerald City of Oz",         0 },
        { "The Patchwork Girl of Oz",       0 },
        { "Tik-Tok of Oz",                  0 },

        // [01] Barsoom / Mars (Edgar Rice Burroughs)
        { "A Princess of Mars",             1 },
        { "The Gods of Mars",               1 },
        { "The Warlord of Mars",            1 },
        { "Thuvia, Maid of Mars",           1 },
        { "The Chessmen of Mars",           1 },

        // [02] Tarzan + Pellucidar + Land That Time Forgot + Moon (Burroughs)
        { "Tarzan of the Apes",             2 },
        { "The Return of Tarzan",           2 },
        { "Tarzan and the Jewels of Opar",  2 },
        { "At the Earth's Core",            2 },
        { "Pellucidar",                     2 },
        { "Tanar of Pellucidar",            2 },
        { "The Land That Time Forgot",      2 },
        { "The People That Time Forgot",    2 },
        { "The Moon Maid",                  2 },
        { "The Moon Men",                   2 },

        // [03] Sherlock Holmes (Arthur Conan Doyle)
        { "A Study in Scarlet",                    3 },
        { "The Sign of the Four",                  3 },
        { "The Adventures of Sherlock Holmes",     3 },
        { "The Memoirs of Sherlock Holmes",        3 },
        { "The Return of Sherlock Holmes",         3 },
        { "The Hound of the Baskervilles",         3 },
        { "The Valley of Fear",                    3 },
        { "His Last Bow",                          3 },
        { "The Case-Book of Sherlock Holmes",      3 },

        // [04] Arsène Lupin (Maurice Leblanc)
        { "Arsène Lupin, Gentleman Burglar",       4 },
        { "Arsène Lupin vs. Herlock Sholmes",      4 },
        { "The Hollow Needle",                     4 },
        { "813",                                   4 },
        { "The Crystal Stopper",                   4 },
        { "The Confessions of Arsène Lupin",       4 },
        { "The Double Affair",                     4 },

        // [05] Father Brown (G.K. Chesterton)
        { "The Innocence of Father Brown",         5 },
        { "The Wisdom of Father Brown",            5 },
        { "The Incredulity of Father Brown",       5 },
        { "The Secret of Father Brown",            5 },
        { "The Scandal of Father Brown",           5 },

        // [06] Cthulhu Mythos (H.P. Lovecraft)
        { "The Call of Cthulhu",                   6 },
        { "The Dunwich Horror",                    6 },
        { "At the Mountains of Madness",           6 },
        { "The Shadow over Innsmouth",             6 },
        { "The Shadow out of Time",                6 },
        { "The Case of Charles Dexter Ward",       6 },
        { "Herbert West: Reanimator",              6 },
        { "The Colour out of Space",               6 },
        { "The Whisperer in Darkness",             6 },
        { "The Horror at Red Hook",                6 },
        { "Pickman's Model",                       6 },
        { "The Rats in the Walls",                 6 },
        { "The Music of Erich Zann",               6 },
        { "The Lurking Fear",                      6 },

        // [07] Musketeers + Monte Cristo (Alexandre Dumas)
        { "The Three Musketeers",                  7 },
        { "Twenty Years After",                    7 },
        { "The Vicomte de Bragelonne",             7 },
        { "The Count of Monte Cristo",             7 },

        // [09] Space Trilogy (C.S. Lewis)
        { "Out of the Silent Planet",              9 },
        { "Perelandra",                            9 },
        { "That Hideous Strength",                 9 },

        // [10] Erewhon (Samuel Butler) + Ruritania (Anthony Hope)
        { "Erewhon",                               10 },
        { "Erewhon Revisited",                     10 },
        { "The Prisoner of Zenda",                 10 },
        { "Rupert of Hentzau",                     10 },

        // [11] Detective series: Martin Hewitt + Max Carrados + MacDonald's Hannay
        { "Martin Hewitt, Investigator",           11 },
        { "Chronicles of Martin Hewitt",           11 },
        { "Adventures of Martin Hewitt",           11 },
        { "Max Carrados",                          11 },
        { "The Eyes of Max Carrados",              11 },
        { "Max Carrados Mysteries",                11 },
        { "The Rasp",                              11 },
        { "The Link",                              11 },
        { "The Noose",                             11 },
        { "The Maze",                              11 },

        // [12] Alice (Lewis Carroll) + Peter Pan (J.M. Barrie)
        { "Alice's Adventures in Wonderland",      12 },
        { "Through the Looking-Glass",             12 },
        { "Peter Pan",                             12 },
        { "The Little White Bird",                 12 },

        // [13] Plato + Aristotle (Ancient Philosophy)
        { "The Republic",                          13 },
        { "The Symposium",                         13 },
        { "Phaedo",                                13 },
        { "The Apology",                           13 },
        ...
        // [14] Nietzsche complete works
        { "Thus Spoke Zarathustra",                14 },
        { "Beyond Good and Evil",                  14 },
        { "On the Genealogy of Morality",          14 },
        { "The Birth of Tragedy",                  14 },
        { "Human, All Too Human",                  14 },
        { "The Gay Science",                       14 },
        { "Twilight of the Idols",                 14 },
        { "Ecce Homo",                             14 },
        { "The Will to Power",                     14 },

        // [15] Kant — three Critiques
        { "Critique of Pure Reason",               15 },
        { "Critique of Practical Reason",          15 },
        { "Critique of Judgement",                 15 },
        { "Groundwork of the Metaphysics of Morals", 15 },
    };
    ...
    private void DrawHeader()
    {
        ...
        EditorGUILayout.LabelField(
            "Genre / Author folders  •  Series color lock",
    ...
    {
        _showPrefabs = EditorGUILayout.Foldout(_showPrefabs, "🎨 16 Color Prefabs", true);
        if (!_showPrefabs) return;

        EditorGUI.indentLevel++;

        // Мітки серій для кожного слота
        var slotLabels = new string[16]
        {
            "[00] Oz (Baum)",
            "[01] Barsoom/Mars (Burroughs)",
            "[02] Tarzan + Pellucidar (Burroughs)",
            "[03] Sherlock Holmes (Doyle)",
            "[04] Arsène Lupin (Leblanc)",
            "[05] Father Brown (Chesterton)",
            "[06] Cthulhu Mythos (Lovecraft)",
            "[07] Musketeers / Monte Cristo (Dumas)",
            "[08] free",
            "[09] Space Trilogy (C.S. Lewis)",
            "[10] Erewhon + Ruritania",
            "[11] Hewitt / Carrados / MacDonald",
            "[12] Alice + Peter Pan",
            "[13] Plato + Aristotle",
            "[14] Nietzsche",
            "[15] Kant Critiques",
        ...
        GUI.contentColor = assigned == 16 ? Color.green
                         : assigned >  0  ? Color.yellow
                         :                  Color.red;
        EditorGUILayout.LabelField($"Призначено: {assigned}/16", EditorStyles.miniLabel);
        ...
        for (int i = 0; i < 16; i++)
        {
            ...
            rect.y += 3;
            EditorGUI.DrawRect(rect, _colorPrefabs[i] != null
                ? new Color(0.3f, 0.85f, 0.4f)
                : new Color(0.4f, 0.4f, 0.4f));

            _colorPrefabs[i] = (GameObject)EditorGUILayout.ObjectField(
                slotLabels[i], _colorPrefabs[i], typeof(GameObject), false);
        ...
        EditorGUILayout.Space(4);
        EditorGUILayout.BeginHorizontal();
        if (GUILayout.Button("🔍 Auto-Find у проєкті")) AutoFindPrefabs();
    ...
    {
        _showStats = EditorGUILayout.Foldout(_showStats, "📊 Статистика", true);
        if (!_showStats) return;

        EditorGUI.indentLevel++;

        // По жанрах
        var byGenre = BookData.GroupBy(e => e.genre)
                              .OrderBy(g => g.Key.ToString());
        foreach (var g in byGenre)
            EditorGUILayout.LabelField(g.Key.ToString(), $"{g.Count()} книг", EditorStyles.miniLabel);
        ...
        // Серії
        int seriesLocked = BookData.Count(e =>
            !string.IsNullOrEmpty(e.title) && SeriesColorMap.ContainsKey(e.title));
        EditorGUILayout.LabelField("Серії (фіксований колір)", $"{seriesLocked} книг",
        ...
        if (validPrefabs == 0)
            ...
            EditorGUILayout.HelpBox(
                $"Призначено {validPrefabs}/16 префабів.\n" +
                "Незайняті слоти серій отримають перший доступний префаб.",
                MessageType.Info);
    ...
    private void DrawGenerateButton()
    {
        ...
        if (GUILayout.Button("🚀  Генерувати", new GUIStyle(GUI.skin.button)
            { fontSize = 13, fixedHeight = 38 }))
            Generate();
    ...
    private void AutoFindPrefabs()
    {
        ...
        if (found == 0)
            EditorUtility.DisplayDialog("Auto-Find",
                "Не знайдено. Переконайся що префаби мають назви:\nBook_Color_00 … Book_Color_15", "OK");
        else
    ...
    private void Generate()
    {
        ...
        if (_clearExisting && Directory.Exists(_outputPath))
        {
            if (!EditorUtility.DisplayDialog("Підтвердження",
                $"Видалити всі .asset з\n{_outputPath}?", "Так", "Скасувати"))
                return;

            foreach (var g in AssetDatabase.FindAssets("t:BookTemplate", new[] { _outputPath }))
                AssetDatabase.DeleteAsset(AssetDatabase.GUIDToAssetPath(g));

            AssetDatabase.Refresh();
        }

        // Групуємо по жанру → автору
        var byGenreAuthor = BookData
            .Where(e => !string.IsNullOrEmpty(e.title) && !string.IsNullOrEmpty(e.author))
            .GroupBy(e => e.genre)
            .ToDictionary(
                g => g.Key,
                g => g.GroupBy(e => e.author)
                       .ToDictionary(a => a.Key, a => a.ToList()));

        int total = 0;

        // Fallback-префаб для серій чий colorIndex не має призначеного префабу
        GameObject FallbackPrefab() => validPrefabs[0].go;
        int FallbackColor()         => validPrefabs[0].colorIndex;

        AssetDatabase.StartAssetEditing();
        try
        {
            foreach (var (genre, authorDict) in byGenreAuthor)
            {
                // Assets/Data/Books/Generated/Fantasy/
                string genreFolder = Path.Combine(_outputPath, genre.ToString())
                                         .Replace('\\', '/');
                EnsureDir(genreFolder);

                foreach (var (author, entries) in authorDict)
                {
                    // Assets/Data/Books/Generated/Fantasy/L_Frank_Baum/
                    string authorFolder = Path.Combine(genreFolder, SanitizeFolder(author))
                                             .Replace('\\', '/');
                    EnsureDir(authorFolder);
                    ...
                    foreach (var entry in entries)
                    {
                        ...
                        so.writingYear  = Mathf.Max(entry.year, 1);
                        so.volumeNumber = 1;

                        // ── Колір: серія → фіксований, решта → рандом ──
                        int colorIdx;
                        GameObject prefabGo;

                        if (SeriesColorMap.TryGetValue(entry.title, out int forcedColor))
                        {
                            // Серія — фіксований колір
                            colorIdx = forcedColor;
                            prefabGo = _colorPrefabs[forcedColor] != null
                                ? _colorPrefabs[forcedColor]
                                : FallbackPrefab();

                            if (_colorPrefabs[forcedColor] == null)
                                Debug.LogWarning(
                                    $"[BookGenerator] Серійний колір [{forcedColor:D2}] не призначено " +
                                    $"для «{entry.title}» — використано fallback.");
                        }
                        else
                        {
                            // Звичайна книга — рандомний з доступних
                            var slot = validPrefabs[Random.Range(0, validPrefabs.Count)];
                            colorIdx = slot.colorIndex;
                            prefabGo = slot.go;
                        }

                        so.colorIndex      = colorIdx;
                        so.containerPrefab = prefabGo;
                        so.bookSize        = PrefabToBookSize(prefabGo);

                        (so.buyPrice, so.sellPrice) = CalcPrices(entry.rarity);
                        so.bookID = BookSmartID.Generate(so);

                        // Assets/Data/Books/Generated/Fantasy/L_Frank_Baum/BT_Wonderful_Wizard_of_Oz.asset
                        string assetName = SanitizeFileName(entry.title);
                        string assetPath = $"{authorFolder}/BT_{assetName}.asset";
                ...
                Debug.Log($"[BookGenerator] {genre}: {authorDict.Sum(a => a.Value.Count)} SO " +
                          $"у {authorDict.Count} папках авторів");
            }
        }
        catch (System.Exception ex)
        {
            Debug.LogError($"[BookGenerator] Помилка: {ex}");
        ...
        // Підрахунок серійних
        int seriesCount = BookData.Count(e =>
            !string.IsNullOrEmpty(e.title) && SeriesColorMap.ContainsKey(e.title));

        string summary =
            $"✅ Згенеровано: {total} SO\n" +
            $"📁 Жанрів: {byGenreAuthor.Count}\n" +
            $"👤 Папок авторів: {byGenreAuthor.Sum(g => g.Value.Count)}\n" +
            $"🔒 Серійні (фіксований колір): {seriesCount}";
    ...
    private void RefreshDatabase()
    {
        ...
        foreach (var guid in AssetDatabase.FindAssets("t:BookTemplate", new[] { _outputPath }))
        {
        ...
        AssetDatabase.SaveAssets();
        Debug.Log($"[BookGenerator] BookDatabase: {_database.allBooks.Count} книг.");
    }
    ...
    private static BookSize PrefabToBookSize(GameObject prefab)
    {
        ...
        float h = prefab.transform.localScale.y;
        return h < 0.85f ? BookSize.Small : h > 1.15f ? BookSize.Large : BookSize.Medium;
    }
    ...
    // Для імені ФАЙЛУ: "The Fox Mykyta" → "The_Fox_Mykyta"
    ...
    // Для імені ПАПКИ: "L. Frank Baum" → "L_Frank_Baum"
    private static string SanitizeFolder(string author)
    {
        var invalid = new HashSet<char>(Path.GetInvalidPathChars())
            { ' ', '.', ',', '\'', '"', ':', ';', '!', '?', '(', ')' };
        var sb = new System.Text.StringBuilder();
        foreach (char c in author) sb.Append(invalid.Contains(c) ? '_' : c);
        string r = sb.ToString();
        while (r.Contains("__")) r = r.Replace("__", "_");
        return r.Trim('_');
    }
    ...
    private void SavePrefs()
    {
        ...
        for (int i = 0; i < 16; i++)
        {
            string p = _colorPrefabs[i] != null
                ? AssetDatabase.GetAssetPath(_colorPrefabs[i]) : "";
            EditorPrefs.SetString(PrefKey + $"prefab{i}", p);
        }
    }
    ...
    private void LoadPrefs()
    {
        ...
        for (int i = 0; i < 16; i++)
        {
            string p = EditorPrefs.GetString(PrefKey + $"prefab{i}", "");
            _colorPrefabs[i] = string.IsNullOrEmpty(p) ? null
