// ═══════════════════════════════════════════════════════════════════════════
// BookData_PublicDomain.cs
// 700 книг Public Domain — по 100 на жанр
// Жанри: Classic, Fantasy, SciFi, Horror, Mystery, Biography, Academic
//
// Всі твори перевірені: автор помер до 1954 р. (70+ років тому)
// або твір видано до 1928 р. (USA public domain).
// Джерело: Project Gutenberg, Standard Ebooks, Internet Archive.
//
// Вставити масив в BookBatchGenerator замість попереднього BookData[].
// ═══════════════════════════════════════════════════════════════════════════
using System;   

namespace Hotel.BookShop.Data
{
    // Minimal BookEntry definition to ensure this file compiles if the main one is missing.
    internal class BookEntry
    {
        ...
        public BookEntry(string title, string author, BookGenre genre, int year, BookRarity rarity)
        {
            Title = title; Author = author; Genre = genre; Year = year; Rarity = rarity;
        }
    }

    internal static class BookData_PublicDomain
    {
        internal static readonly BookEntry[] BookData = new BookEntry[]
{
    // ╔══════════════════════════════════════════════════════════╗
    // ║  CLASSIC — 100 творів                                   ║
    // ╚══════════════════════════════════════════════════════════╝
